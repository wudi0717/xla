...
class GpuExecutable : public Executable {
 ...
 private:
  ...
  // MUSA traced command buffers are pointer-specific and cannot be updated.
  // Keep the bounded address-signature cache with the executable that owns the
  // thunk sequence.
  std::unique_ptr<MusaClassicThunkGraphCache> musa_classic_thunk_graph_cache_;
