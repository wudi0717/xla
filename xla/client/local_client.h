...
class LocalExecutable {
 ...
 private:
  ...
  Status VerifyRunDeviceCompatible(int run_device_ordinal) const;
...
class LocalClient : public Client {
 public:
  ...
  // Variant of `Load()` that accepts an already materialized
  // AotCompilationResult.
  StatusOr<std::unique_ptr<LocalExecutable>> Load(
  ...
  StatusOr<GlobalDataHandle> TransferToLocalServer(
 ...
 private:
  ...
  StatusOr<std::unique_ptr<LocalExecutable>> LoadInternal(
