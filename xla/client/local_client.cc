...
Status LocalExecutable::VerifyRunDeviceCompatible(int run_device_ordinal) const {
...
StatusOr<std::unique_ptr<LocalExecutable>> LocalClient::LoadInternal(
...
StatusOr<GlobalDataHandle> LocalClient::TransferToLocalServer(
  ...
  return local_service_->RegisterReplicatedBuffers(
