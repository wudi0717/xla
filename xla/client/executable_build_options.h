...
class ExecutableBuildOptions {
 public:
  ...
  void set_process_index(int process_index) { process_index_ = process_index; }
  int process_count() const { return process_count_; }
  void set_process_count(int process_count) { process_count_ = process_count; }
 ...
 private:
  ...
  EffortLevel optimization_level_ = EFFORT_UNKNOWN;
  EffortLevel memory_fitting_level_ = EFFORT_UNKNOWN;
